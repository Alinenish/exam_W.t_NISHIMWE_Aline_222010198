...
--
-- Host: 127.0.0.1
-- Generation Time: May 23, 2024 at 09:58 AM
...
--
-- Database: `recipes_sharing_platforms`
--
...
CREATE TABLE `list_ingredients` (
  `list_ingredient_id` int(11) NOT NULL,
...
ALTER TABLE `list_ingredients`
  ADD PRIMARY KEY (`list_ingredient_id`),
...
--
ALTER TABLE `list_ingredients`
  MODIFY `list_ingredient_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `list_ingredients`
--
ALTER TABLE `list_ingredients`
  ADD CONSTRAINT `list_ingredients_ibfk_1` FOREIGN KEY (`list_id`) REFERENCES `shopping_lists` (`list_id`),
  ADD CONSTRAINT `list_ingredients_ibfk_2` FOREIGN KEY (`ingredient_id`) REFERENCES `ingredients` (`ingredient_id`);
